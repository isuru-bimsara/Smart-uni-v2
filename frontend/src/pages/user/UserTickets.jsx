...
//                           <span
//                             className={`w-2 h-2 rounded-full ${t.priority === "CRITICAL" ? "bg-rose-500" : t.priority === "HIGH" ? "bg-orange-400" : "bg-blue-400"}`}
//                           ></span>
...
//                         <span
//                           className={`inline-block px-3 py-1 rounded-full text-[10px] font-black border uppercase tracking-widest ${getStatusStyle(t.status)}`}
//                         >
//                           {t.status}
//                         </span>
//                       </td>
