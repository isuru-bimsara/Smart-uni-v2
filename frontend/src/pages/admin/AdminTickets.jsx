    ...
    <div className="max-w-7xl mx-auto p-6 md:p-8 space-y-8 min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
        <div>
          ...
          <p className="text-slate-500 font-medium mt-1.5 ml-1">Full system overview and historical logs.</p>
        </div>
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/40 overflow-hidden">
        {loading ? (
          ...
          <div className="p-32 text-center">
             ...
             <p className="text-slate-400 font-medium mt-1">Try refining your search parameters.</p>
          </div>
        ) : (
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-widest whitespace-nowrap">Ticket Details</th>
                  ...
                  <tr key={t.id} className="group hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-8 py-6">
                      {t.assigneeName ? (
                        ...
                        <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest italic">Open</span>
                      )}
                    </td>
