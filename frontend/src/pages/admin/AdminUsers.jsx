        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1 font-medium">
              Assign roles and monitor system access.
            </p>
          </div>
              ...
              <tbody className="divide-y divide-gray-50">
                {loading ? (
                  <tr>
                    <td
                      colSpan="4"
                      className="py-20 text-center text-gray-400 font-medium animate-pulse"
                    >
                      Retrieving user records...
                    </td>
                  </tr>
                  ...
                  processedUsers.map((u) => (
                    <tr key={u.id} className="hover:bg-indigo-50/30 transition-colors group">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`px-3 py-1 rounded-lg border text-[10px] font-black tracking-widest uppercase flex items-center gap-1.5 w-fit ${getRoleBadge(
                            u.role
                          )}`}
                        >
                          <ShieldCheck className="w-3 h-3" />
